...
def main():
    ...
    axes = [ax01, ax05, ax09, ax02, ax06, ax10, ax03, ax07, ax11, ax04, ax08, ax12]
    ...
    for ax, x, y, df, ylabel in zip(axs, xs, ys, dfs, ylbs):
        sns.regplot(ax=ax, data=df, x=x, y=y, scatter=True, color="r", scatter_kws=skws)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest="subset",
        required=False,
        help="Either train, test or valid.",
        default="test",
    )
