...
def process(df, subset, variable):
    ...
    rmse_ml = np.sqrt(
        mse(df1["{}_buoy".format(variable)], df1["{}_prediction".format(variable)])
    )
    rmse_ww = np.sqrt(
        mse(df1["{}_buoy".format(variable)], df1["{}_wavewatch".format(variable)])
    )

    mae_ml = mae(df1["{}_buoy".format(variable)], df1["{}_prediction".format(variable)])
    mae_ww = mae(df1["{}_buoy".format(variable)], df1["{}_wavewatch".format(variable)])

    mape_ml = mape(
        df1["{}_buoy".format(variable)], df1["{}_prediction".format(variable)]
    )
    mape_ww = mape(
        df1["{}_buoy".format(variable)], df1["{}_wavewatch".format(variable)]
    )
    ...
    hh_ml = HH(df1["{}_buoy".format(variable)], df1["{}_prediction".format(variable)])
    hh_ww = HH(df1["{}_buoy".format(variable)], df1["{}_wavewatch".format(variable)])
